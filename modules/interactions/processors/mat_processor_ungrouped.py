...
class MATProcessorUngrouped(TimeSeriesProcessor):
    ...
    def process(self) -> Optional[pl.LazyFrame]:
        ...
        lazy_frame = lazy_frame.with_columns(
            pl.col(constants.MOVING_ANNUAL_TOTAL_COLUMN_TOTAL_ACTIONS).shift(12, fill_value=0).over(
                group_columns).alias(
        ...
        lazy_frame = lazy_frame.with_columns(
            pl.when(
                pl.col(constants.PERCENTAGE_MOVING_ANNUAL_TOTAL_COLUMN_TOTAL_ACTIONS_CHANGE_LAST_YEAR).is_infinite() |
        ...
        return ProcessorHelper.melt_lazy_frame(
            ...
            {
                constants.MOVING_ANNUAL_TOTAL_COLUMN_TOTAL_ACTIONS: constants.INDICATOR_MOVING_ANNUAL_TOTAL_UNGROUPED,
                constants.PERCENTAGE_MOVING_ANNUAL_TOTAL_COLUMN_TOTAL_ACTIONS_CHANGE_LAST_YEAR: constants.INDICATOR_MOVING_ANNUAL_TOTAL_CHANGE_PREVIOUS_YEAR_UNGROUPED
            },
            {
