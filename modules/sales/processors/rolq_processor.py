...
class ROLQProcessor(TimeSeriesProcessor):
    ...
    def process(self) -> Optional[pl.LazyFrame]:
        ...
        lazy_frame = lazy_frame.with_columns(
            pl.col(constants.ROLLING_QUARTER_COLUMN_SALES).shift(12, fill_value=0).over(constants.COMMON_GROUP_COLUMNS).alias(
                constants.ROLLING_QUARTER_COLUMN_LAST_YEAR_SALES
            ),
            pl.col(constants.ROLLING_QUARTER_COLUMN_UNITS).shift(12, fill_value=0).over(constants.COMMON_GROUP_COLUMNS).alias(
        ...
        return ProcessorHelper.melt_lazy_frame(
            ...
            constants.COMMON_GROUP_COLUMNS,
            {
                ...
                constants.PERCENTAGE_ROLLING_QUARTER_COLUMN_SALES_CHANGE_LAST_YEAR: constants.INDICATOR_ROLLING_QUARTER_CHANGE_PREVIOUS_YEAR_SALES,
                constants.PERCENTAGE_ROLLING_QUARTER_COLUMN_UNITS_CHANGE_LAST_YEAR: constants.INDICATOR_ROLLING_QUARTER_CHANGE_PREVIOUS_YEAR_UNITS
            },
            {
