...
class AnnualProcessorTerritory(TimeSeriesProcessor):
    ...
    def process(self) -> Optional[pl.LazyFrame]:
        ...
        lazy_frame = lazy_frame.with_columns(
            pl.col(constants.COLUMN_SALES).shift(1, fill_value=0).over(constants.TERRITORY_GROUP_COLUMNS).alias(constants.COLUMN_LAST_YEAR_SALES),
            pl.col(constants.COLUMN_UNITS).shift(1, fill_value=0).over(constants.TERRITORY_GROUP_COLUMNS).alias(constants.COLUMN_LAST_YEAR_UNITS),
        )
        uuid_columns = {
        ...
        return ProcessorHelper.melt_lazy_frame(
            ...
            {
                constants.COLUMN_SALES: constants.INDICATOR_SALES_TERRITORY,
                constants.COLUMN_UNITS: constants.INDICATOR_UNITS_TERRITORY,
                constants.PERCENTAGE_COLUMN_SALES_CHANGE_LAST_YEAR: constants.INDICATOR_SALES_CHANGE_PREVIOUS_YEAR_TERRITORY,
                constants.PERCENTAGE_COLUMN_UNITS_CHANGE_LAST_YEAR: constants.INDICATOR_UNITS_CHANGE_PREVIOUS_YEAR_TERRITORY
            },
            {
            ...
            {
                constants.COLUMN_SALES: global_constants.PERIOD_YEAR,
                constants.COLUMN_UNITS: global_constants.PERIOD_YEAR,
                constants.PERCENTAGE_COLUMN_SALES_CHANGE_LAST_YEAR: global_constants.PERIOD_YEAR,
                constants.PERCENTAGE_COLUMN_UNITS_CHANGE_LAST_YEAR: global_constants.PERIOD_YEAR
            },
