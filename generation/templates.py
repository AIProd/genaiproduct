                    ...
                    <td>
                        <main>
                            ...
                            >
                                ...
                                <div style="margin-top: 1px; padding: 2px 2px;font-size: 18px;">
                                    <span style="
                            {% if ter_target == 'A' or ter_target == 'B' %}
                                font-weight: bold; background-color: yellow; color: black;
                                {% endif %}">
                                                    Overall Priority: {{ter_target}}
                                        </span>                             
                                    </div>
                            ...
                            >
                                <div class="card no-split">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="color-secondary">
                                                <span>{{visit.meeting_date_time}}</span>
                                            </td>
                                            <td class="color-secondary">
                                                <span>{{visit.hcp_name}}</span>
                                            </td>
                                            <td class="color-secondary">
                                ...
                                <div style="display: flex; gap: 16px;">
                                    <div>
                                        ...
                                        <div>
                                            <p>
                                                For <strong>{{visit.hcp_name}}</strong> we've identified <strong>{{visit.number_of_key_points}}</strong>
                                                key points.
                                            </p>
                                        </div>
                                        {% endfor %}
